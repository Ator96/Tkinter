        ...
        if (raiz in self.raiz.hijos or raiz == "-"):
            ...
            while (len(cola) > 0):
                ...
                for hijo in actual.hijos.values():
                    ...
                    print("(" + hijo.id + ", " + str(actual.hijos[hijo.id].nivel) + " " + str(
                        actual.hijos[hijo.id].definicion) + ")")
...
label1 = Label(topFrame,
               text="Primer proyecto de Estructura de Datos y Algoritmos II\nOscar Gutiérrez Castillo\nCarlos Alberto Hernandez Arrieta\nAxel Mauricio Hernandez Lopez\nAlexis Saul Domínguez Cisneros",
               font=("Helvetica", 10))
